...
if __name__ == '__main__':
    ...
    gamma = 0.99  # 折扣因子
    actor_lr = 1e-6  # 策略网络的学习率
    critic_lr = 1e-6  # 价值网络的学习率
    n_hiddens = 256  # 隐含层神经元个数
    return_list = []  # 保存每个回合的return
    sample_rounds = 8  # 每次训练用了多少轮的数据
    ...
    torch.save(actor.state_dict(), "actor7.pt")
    torch.save(critic.state_dict(), "critic7.pt")
